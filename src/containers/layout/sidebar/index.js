        ...
        return (
            <div className="cv-main-sidebar">
                ...
                <div className="info-version">
                    ...
                    <div>
                        <span className="title-info-text"><IntlMessages id={'sidebar.info_text.person_access'} /> {this.state.likeNumber} </span>
                        <span><Icon name='like' color={"red"}/></span>
                    </div>
                    <div>
                        <span className="title-info-text"><IntlMessages id={'sidebar.info_text.ip_client'} /><span id="ip_user_client"></span></span>
                    </div>
                    <div>
                        <span className="title-info-text"><IntlMessages id={'sidebar.info_text.city_user_client'} /><span id="city_user_client"></span></span>
                    </div>
                </div>
            </div>
        );
