  ...
  constructor(props) {
    ...
    this.state = {
      link: {
        ...
        blog: 'http://blogitnlu.azurewebsites.net/',
        website: 'http://nguyenlephong0107.azurewebsites.net/',
      ...
      shortLink: {
        ...
        blog: "http://bit.ly/2rhGFC3",
        website: "http://bit.ly/2EHyQJ3",
        ...
        <Grid padded columns={1} relaxed>
          ...
          <Grid.Row columns={2} className="cv-content_link">
            <Grid.Column
              mobile={16} tablet={4} computer={3}>
                            <span className="link__title-description"> 
                                <Icon color={colorIcon} name={iconName}/> Website:
                            </span>
            </Grid.Column>
            <Grid.Column
              mobile={16} tablet={12} computer={13}>
              <a href={link.website} className="link__strong">{shortLink.website}</a>
            </Grid.Column>
          </Grid.Row>
