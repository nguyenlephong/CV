        ...
        <Timeline mode="alternate">
          <Timeline.Item dot={<Icon type="clock-circle-o" style={{fontSize: '32px'}}/>} color="green">
            <div className="content-body-timeline-item">
              ...
              <h4 className="vertical-timeline-element-subtitle"><IntlMessages id={'topbar.project_banktool.subtitle'}/>
              </h4>
          ...
          <Timeline.Item dot={<Icon type="clock-circle-o" style={{fontSize: '32px'}}/>} color="green">
            <div className="content-body-timeline-item">
              <span className="vertical-timeline-element-date left"><IntlMessages
                id={'topbar.project_wat.date'}/></span>
          ...
          <Timeline.Item dot={<Icon type="clock-circle-o" style={{fontSize: '32px'}}/>} color="green">
            <div className="content-body-timeline-item">
              <span className="vertical-timeline-element-date left"><IntlMessages
                id={'topbar.project_savyu.date'}/></span>
              <h3 className="vertical-timeline-element-title"><IntlMessages id={'topbar.project_savyu.title'}/></h3>
              <h4 className="vertical-timeline-element-subtitle"><IntlMessages id={'topbar.project_savyu.subtitle'}/>
              </h4>
          ...
          <Timeline.Item dot={<Icon type="clock-circle-o" style={{fontSize: '32px'}}/>} color="green">
            <div className="content-body-timeline-item">
              ...
              <h4 className="vertical-timeline-element-subtitle"><IntlMessages id={'topbar.project_froodini.subtitle'}/>
              </h4>
          ...
          <Timeline.Item dot={<Icon type="clock-circle-o" style={{fontSize: '32px'}}/>} color="green">
            <div className="content-body-timeline-item">
              <span className="vertical-timeline-element-date left"><IntlMessages
                id={'topbar.project_essay.date'}/></span>
              <h3 className="vertical-timeline-element-title"><IntlMessages id={'topbar.project_essay.title'}/></h3>
              <h4 className="vertical-timeline-element-subtitle"><IntlMessages id={'topbar.project_essay.subtitle'}/>
              </h4>
          ...
          <Timeline.Item dot={<Icon type="clock-circle-o" style={{fontSize: '32px'}}/>} color="green">
            <div className="content-body-timeline-item">
              ...
              <h4 className="vertical-timeline-element-subtitle"><IntlMessages
                id={'topbar.project_rentalcar.subtitle'}/></h4>
          ...
          <Timeline.Item dot={<Icon type="clock-circle-o" style={{fontSize: '32px'}}/>} color="green">
            <div className="content-body-timeline-item">
              ...
              <h4 className="vertical-timeline-element-subtitle"><IntlMessages id={'topbar.project_chess.subtitle'}/>
              </h4>
          ...
          <Timeline.Item dot={<Icon type="clock-circle-o" style={{fontSize: '32px'}}/>} color="green">
            <div className="content-body-timeline-item">
              ...
              <h3 className="vertical-timeline-element-title"><IntlMessages id={'topbar.project_shoppingweb.title'}/>
              </h3>
              <h4 className="vertical-timeline-element-subtitle"><IntlMessages
          ...
          <Timeline.Item dot={<Icon type="clock-circle-o" style={{fontSize: '32px'}}/>} color="green">
            <div className="content-body-timeline-item">
              <span className="vertical-timeline-element-date left"><IntlMessages
                id={'topbar.project_boom.date'}/></span>
              <h3 className="vertical-timeline-element-title"><IntlMessages id={'topbar.project_boom.title'}/></h3>
              <h4 className="vertical-timeline-element-subtitle"><IntlMessages id={'topbar.project_boom.subtitle'}/>
              </h4>
